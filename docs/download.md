...
!!! note "First release in final testing"
    Venu Pacific 26.08.7 — the first public release — is currently in final
...
| File | What it is |
|---|---|
| [`venu-pacific-26.08.7-amd64.iso`](https://download.venupacific.org/venu-pacific-26.08.7-amd64.iso) | The system image (~4.7 GB) |
| [`venu-pacific-26.08.7-amd64.iso.sha256`](https://download.venupacific.org/venu-pacific-26.08.7-amd64.iso.sha256) | Its checksum, for verifying the download |
...
```bash
sha256sum -c venu-pacific-26.08.7-amd64.iso.sha256
```

On Windows (PowerShell):

```powershell
Get-FileHash venu-pacific-26.08.7-amd64.iso -Algorithm SHA256
```
